...
export default function PropertyDetailsPage({ broker, property }: PropertyDetailsPageProps) {
      ...
      <main className="flex-1 w-full flex flex-col items-center pb-20">
          ...
          <div className="lg:col-span-2 flex flex-col gap-10">
            <div className="bg-white rounded-2xl p-6 border border-gray-100 shadow-sm grid grid-cols-2 md:grid-cols-4 gap-6 items-center justify-items-center">
              ...
              <div className="flex flex-col items-center gap-1 text-center border-l border-gray-100 pl-6 w-full">
                ...
                <span className="text-2xl font-black text-text-main">{caracteristicasimovel.quartos?.join(', ')}</span>
            ...
            <div>
              ...
              <div className="rounded-2xl overflow-hidden h-80 w-full bg-gray-200 relative shadow-soft">
                <div className="absolute inset-0 bg-cover bg-center opacity-60" style={{ backgroundImage: `url("https://lh3.googleusercontent.com/aida-public/AB6AXuCFSXKPYHVcn6bMCHX6E36kKsWYH-Jrnidp5qgbqRJGbl2tdlfAHRWGgw_BH0FSGiuPAeKoFjGKd4iIxXaS7RDxBjhDpxchyUI6ZBIYy7at-GoSMkswUwLtYY2J431RQH8lRwvQ71Fextok_2cbHyuBu2WkdM3MerdFb1zeCcIMCEPpddgbOA9bubnLDWwsPuexTRzdQSnvapPmcLOzJ-pHK_tWJ-1E5X7glsU1dhw3RJ7oeECQqHntdfmjefwEy47loPNgWOSqzY0")`, filter: 'grayscale(100%)' }}></div>
                <div className="absolute inset-0 flex items-center justify-center">
                  <div className="bg-white p-4 rounded-xl shadow-lg flex flex-col items-center">
                    <span className="material-symbols-outlined text-red-500 text-4xl mb-2">location_on</span>
                    <span className="font-bold text-text-main text-sm">{localizacao.bairro}, {localizacao.cidade}</span>
                    <button className="mt-2 text-xs font-bold text-primary bg-black px-3 py-1.5 rounded-full hover:bg-gray-800 transition-colors">
                      Ver no Google Maps
                    </button>
                  </div>
                </div>
        ...
        <section className="w-full max-w-[1280px] px-6 mt-20">
          <div className="flex items-center justify-between mb-8">
            ...
            <a className="text-sm font-bold text-primary bg-black px-4 py-2 rounded-full hover:bg-gray-900 transition-colors" href="#">Ver todos</a>
          </div>
