        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            {properties.map(property => (
                <div key={property.id} className="border rounded-lg p-4">
                    <Image src={property.midia?.[0] || (property as any).media?.[0] || 'https://picsum.photos/seed/fallback/600/400'} alt={property.informacoesbasicas.nome} width={600} height={400} className="w-full h-48 object-cover rounded-md mb-4"/>
