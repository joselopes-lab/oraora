            ...
            <div className="lg:col-span-2 space-y-8">
                ...
                <div className="bg-white rounded-xl shadow-soft border border-gray-100 overflow-hidden">
                 ...
                 <div className="bg-white rounded-xl shadow-soft border border-gray-100 overflow-hidden">
                    ...
                    <div className="p-6 space-y-4">
                       {recommendedProperties.length > 0 ? recommendedProperties.map((prop) => (
                           <div key={prop.id} className="flex items-center gap-4 p-3 bg-gray-50 rounded-lg border border-gray-100 hover:shadow-md transition-shadow">
                               <Checkbox
                                    id={`prop-${prop.id}`}
                 ...
                 <div className="bg-white rounded-xl shadow-soft border border-gray-100 overflow-hidden">
                    ...
                    <div className="p-6">
                        <div className="relative pl-4 border-l border-gray-200 space-y-8">
                             {/* Mock data, this would come from a subcollection */}
                            <div className="relative group">
                                ...
                                <div className="flex flex-col sm:flex-row sm:items-baseline justify-between mb-1">
                                    <h4 className="font-bold text-sm text-text-main">Visita ao Imóvel Ref. 4022</h4>
                                    <span className="text-xs text-text-secondary font-medium">Hoje, 14:30</span>
                                </div>
                                <p className="text-sm text-gray-600 bg-gray-50 p-3 rounded-lg border border-gray-100">
                                    Cliente gostou bastante da iluminação natural. Achou a cozinha um pouco pequena, mas considerou a possibilidade de integrar com a sala.
                                </p>
                            </div>
                            <div className="relative group">
                                ...
                                <div className="flex flex-col sm:flex-row sm:items-baseline justify-between mb-1">
                                    ...
                                    <span className="text-xs text-text-secondary font-medium">{new Date(client.createdAt).toLocaleDateString('pt-BR', {day: '2-digit', month: 'short'})}</span>
                                </div>
                ...
                <div className="bg-white rounded-xl shadow-soft border border-gray-100 p-6 sticky top-24">
                    ...
                    <details className="group bg-gray-50 rounded-lg border border-gray-200 open:bg-white open:ring-2 open:ring-secondary/20 transition-all duration-300">
                        ...
                        <div className="p-3 pt-0 animate-fade-in border-t border-gray-100 mt-2">
                            <textarea className="w-full bg-gray-50 border border-gray-200 rounded-lg px-3 py-2 text-sm text-text-main focus:ring-2 focus:ring-primary/50 focus:border-primary outline-none transition-all placeholder-gray-400 min-h-[100px] mb-2" placeholder="Digite sua nota sobre o cliente..."></textarea>
                            <button className="w-full bg-secondary hover:bg-primary text-white hover:text-black font-bold py-2 rounded-lg text-sm transition-colors shadow-sm">
                                Salvar Nota
                            </button>
                        </div>
                    </details>
