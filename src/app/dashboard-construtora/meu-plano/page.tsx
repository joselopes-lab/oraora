...
export default function MeuPlanoPage() {
    ...
    useEffect(() => {
        ...
        const plansQuery = query(collection(db, 'plans'), where('type', '==', 'construtora'));
                                    ...
                                    <div className="pt-4">
                                        ...
                                        <span className="text-muted-foreground">{period}</span>
                                         {billingCycle === 'annual' && plan.priceAnnual && (
                                            <p className="text-sm text-green-600 font-semibold mt-1">Economize {formatCurrency((plan.price * 12) - plan.priceAnnual)}!</p>
                                        )}
                                    </div>
                                </CardHeader>
                                    ...
                                    <ul className="space-y-3">
                                        ...
                                        {plan.userLimit !== undefined && (
                                            <li className="flex items-start gap-2">
                                                ...
                                                <span>Até <strong>{plan.userLimit} usuários</strong></span>
                                            </li>
                                        )}
                                    </ul>
                                </CardContent>
