          ...
          <div>
            ...
            <ul className="flex flex-col gap-3 text-gray-400 text-sm">
              {broker.footerContactEmail && <li className="flex items-center justify-center md:justify-start gap-2">
                <span className="material-symbols-outlined text-base" style={{ color: 'white' }}>mail</span>
              ...
              {broker.footerContactPhone && <li className="flex items-center justify-center md:justify-start gap-2">
                <span className="material-symbols-outlined text-base" style={{ color: 'white' }}>phone</span>
                {broker.footerContactPhone}
              </li>}
              {broker.footerContactAddress && <li className="flex items-start justify-center md:justify-start gap-2">
                <span className="material-symbols-outlined text-base shrink-0" style={{ color: 'white' }}>pin_drop</span>
          ...
          <div className="flex items-center gap-2">
            ...
            >
              <Image 
                ...
                width={80} 
                height={20} 
                className="h-4 w-auto grayscale brightness-200 opacity-60" 
              />
            </a>
          </div>
        </div>
