...
export function UrbanPadraoFooter({ broker }: { broker: Broker }) {
  ...
  return (
    <footer className="bg-black text-white pt-16 pb-8 border-t border-gray-800 text-left">
      <div className="layout-container max-w-[1280px] mx-auto px-6 text-center md:text-left">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          <div className="flex flex-col gap-4 items-center md:items-start text-center md:text-left">
            <div className="flex items-center justify-center md:justify-start gap-3 mb-4">
               {broker.footerLogoUrl ? (
                ...
                <Image src={broker.logoUrl} alt={`Logo de ${broker.brandName}`} width={160} height={40} className="h-8 w-auto object-contain rounded-lg" style={{ width: 'auto' }} />
              ) : (
          ...
          <div className="text-left">
            ...
            <ul className="flex flex-col gap-2 text-gray-400 text-sm">
              ...
              <li><Link className="hover:text-primary transition-colors" href={nav.services()}>Serviços</Link></li>
          ...
          <div className="text-left">
            ...
            <ul className="flex flex-col gap-2 text-gray-400 text-sm">
              ...
              <li><Link className="hover:text-primary transition-colors" href={nav.search('type=Casa')}>Casas de Condomínio</Link></li>
              <li><Link className="hover:text-primary transition-colors" href={nav.search('type=Cobertura')}>Coberturas</Link></li>
              <li><Link className="hover:text-primary transition-colors" href={nav.search('type=Terreno')}>Terrenos</Link></li>
            </ul>
          </div>
          <div className="text-left">
        ...
        <div className="border-t border-gray-800 pt-8 flex flex-col md:flex-row justify-between items-center gap-4 text-xs text-gray-500">
          ...
          <div className="flex items-center gap-1.5 whitespace-nowrap">
            <span className="opacity-60 text-gray-400 font-bold uppercase tracking-widest text-[9px]">Criado por</span>
            <a 
