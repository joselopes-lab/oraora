                                ...
                                <nav className="flex items-center gap-2">
                                    ...
                                    {Array.from({ length: totalPages }, (_, i) => (
                                        <button
                                            ...
                                            className={cn("flex items-center justify-center size-10 rounded-full border border-gray-200 font-medium transition-all", currentPage === i + 1 ? 'bg-primary text-white font-bold shadow-md' : 'bg-white text-text-muted hover:bg-gray-100 hover:border-gray-300')}
                                        >
                                            {i + 1}
                                        </button>
                                    ))}
