  ...
  return (
    <div className="bg-background-light text-text-main font-display antialiased overflow-x-hidden selection:bg-primary selection:text-black">
      <div className="relative flex min-h-screen w-full flex-col group/design-root">
        ...
        <main className="flex-1 w-full flex relative h-[calc(100vh-80px)] overflow-hidden">
                ...
                <div className="bg-white w-full max-w-[400px] rounded-2xl shadow-float overflow-hidden flex flex-col animate-in fade-in zoom-in-95 duration-200 relative" onClick={(e) => e.stopPropagation()}>
                    ...
                    <div className="p-5 flex flex-col gap-3">
                        ...
                        <div className="flex gap-3 mt-2">
                            <Link href={`/sites/${broker.slug}/imovel/${selectedProperty.id}`} className="flex-1 bg-primary hover:bg-primary-hover text-black font-bold h-11 rounded-xl shadow-lg shadow-primary/20 flex items-center justify-center gap-2 transition-all hover:scale-[1.02]">
                                Ver Detalhes
