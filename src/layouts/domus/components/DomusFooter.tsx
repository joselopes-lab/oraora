...
export function DomusFooter({ broker }: { broker: Broker }) {
  ...
  return (
    <footer className="bg-white dark:bg-background-dark border-t border-[#f3f4f0] dark:border-white/5 py-16 text-left">
      <div className="max-w-[1280px] mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          ...
          <div>
            <h4 className="text-sm font-bold text-[#161811]/40 dark:text-white/40 uppercase tracking-widest mb-6">Explorar</h4>
            <ul className="flex flex-col gap-3 text-sm font-medium">
              <li><Link className="text-[#161811]/80 dark:text-white/80 hover:text-primary transition-colors" href={nav.home()}>Início</Link></li>
              <li><Link className="text-[#161811]/80 dark:text-white/80 hover:text-primary transition-colors" href={nav.search()}>Catálogo</Link></li>
              <li><Link className="text-[#161811]/80 dark:text-white/80 hover:text-primary transition-colors" href={nav.about()}>Sobre Mim</Link></li>
              <li><Link className="text-[#161811]/80 dark:text-white/80 hover:text-primary transition-colors" href={nav.contact()}>Contato</Link></li>
            </ul>
          </div>
          <div>
        ...
        <div className="border-t border-[#f3f4f0] dark:border-white/5 pt-8 flex flex-col md:flex-row justify-between items-center gap-4 text-center md:text-left">
          <div className="flex flex-col gap-1">
            ...
            <div className="flex gap-6 text-xs font-medium text-[#161811]/60 dark:text-white/60">
              <Link className="hover:text-primary transition-colors" href={nav.terms()}>Termos de Uso</Link>
              <Link className="hover:text-primary transition-colors" href={nav.privacy()}>Política de Privacidade</Link>
            </div>
          </div>
