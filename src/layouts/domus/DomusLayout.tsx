              ...
              <Link key={property.id} href={`/sites/${broker.slug}/imovel/${property.informacoesbasicas.slug || property.id}`} className="flex flex-col gap-4 group cursor-pointer">
                ...
                <div className="flex flex-col gap-2">
                  ...
                  <div className="flex flex-col mt-2">
                    ...
                    <p className="text-[#161811] dark:text-white text-2xl font-bold" style={{ color: 'var(--card-value)' }}>{property.informacoesbasicas.valor?.toLocaleString('pt-BR', { style: 'currency', currency: 'BRL' }) || 'Consulte'}</p>
                  </div>
                </div>
              </Link>
            )})}
          ...
          <div className="max-w-[1280px] mx-auto px-6">
            <div className="flex flex-col lg:flex-row gap-16 items-center">
              ...
              <div className="w-full lg:w-1/2 flex flex-col gap-10">
                <div className="flex flex-col gap-4">
                  <span className="px-3 py-1 bg-primary/20 text-background-dark dark:text-primary rounded-full text-xs font-bold uppercase tracking-wider w-fit" style={{ color: 'var(--about-tagline-color)' }}>{content.aboutTagline || defaultContent.aboutTagline}</span>
